...
class _CustomGradient extends StatefulWidget {
  ...
  @override
  State<_CustomGradient> createState() => __CustomGradientState();
}

class __CustomGradientState extends State<_CustomGradient> {
  @override
  Widget build(BuildContext context) {
